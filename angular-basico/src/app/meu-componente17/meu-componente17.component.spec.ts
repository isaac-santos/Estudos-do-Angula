...
import { MeuComponente17Component } from './meu-componente17.component';
...
describe('Testando componente 17', () => {
  ...
  beforeEach(async () => {
    await TestBed.configureTestingModule({
      imports: [MeuComponente17Component]
    }).compileComponents();
  });
  ...
  it('Validar variável nome', () => {
    ...
    // Fixture
    const fixture = TestBed.createComponent(MeuComponente17Component);

    // Obter as variáveis e funções do componente
    const componente = fixture.componentInstance;

    // Validação
    expect(componente.nome).toEqual('Isaac');
